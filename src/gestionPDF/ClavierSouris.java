...
public class ClavierSouris implements KeyListener, MouseWheelListener, MouseMotionListener, MouseListener, ComponentListener {
    ...
    /**
     * Permet de changer en mode unifié ou différencié selon la valeur envoyé et si il y a bien 2 fenetre
     * @param nouvelleValeur nouvelle valeur affecté a unified
     */
    public void setUnified(boolean nouvelleValeur) {
        ...
        if (fenetreApp.size() == 2) {
            ...
            // Place les icons dans les menus selon le mode actuel
            if (unified == true){
